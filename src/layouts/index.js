...
export const defaultHelmetMeta = [
  <meta key="og:title" property="og:title" content="SPB Frontend" />,
  <meta
    key="og:description"
  ...
  />,
  <meta key="og:url" property="og:url" content="http://spb-frontend.ru/" />,
  <meta key="twitter:card" name="twitter:card" content="summary_large_image" />,
  <meta key="twitter:site" name="twitter:site" content="@spb_frontend" />,
  <meta
  ...
  <meta
    ...
    content="Петербургское сообщество фронтенд-разработчиков"
  />,
  <meta key="keywords" name="keywords" content="frontend, spb-frontend" />,
]
