...
module.exports = props =>
  <div className='page'>
    ...
    <div className='page--container'>
      <aside className='page--aside'>
        ...
        <dl className='contacts'>
          ...
          <dd className='contacts--desc'><a href='http://slack.spb-frontend.ru/'>slack.spb-frontend.ru</a></dd>
          <dt className='contacts--term'>Гитхаб</dt>
          <dd className='contacts--desc'><a href='https://github.com/spb-frontend'>spb-frontend</a></dd>
    ...
    <footer className='page--footer'>
      <div><a href='https://github.com/spb-frontend/spb-frontend.ru'>Сайт на гитхабе</a></div>
    </footer>
  </div>
